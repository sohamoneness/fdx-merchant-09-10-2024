...
public class CreateCouponRequestModel {
    ...
    public CreateCouponRequestModel(String restaurant_id, String title, String description,
                                    String code, String type, String rate, String maximum_offer_rate,
                                    String start_date, String end_date, String maximum_time_of_use,
                                    String maximum_time_user_can_use) {
