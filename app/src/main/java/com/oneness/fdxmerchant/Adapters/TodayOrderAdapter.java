...
import static com.oneness.fdxmerchant.Activity.Order.OrderDetails.ordId;
...
public class TodayOrderAdapter extends RecyclerView.Adapter<TodayOrderAdapter.Hold> {
    ...
    public TodayOrderAdapter(FragmentActivity activity, List<NewOrdersModel> todayOrderList) {
    ...
    public void onBindViewHolder(@NonNull TodayOrderAdapter.Hold holder, int position) {
        ...
        holder.tvPromoDiscount.setText("₹ " + formatted3);
        ...
        String formatted5 = formatter1.format(Double.parseDouble(om.tax_amount));
        if (formatted5.equals(".00")){
            formatted5 = "0.00";
        }
        holder.tvTax.setText("₹ " + formatted5);
        ...
        holder.totBillLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.ivArrow.startAnimation(rotate);*/
            }
        });
    ...
    private void showPopup(String from, NewOrdersModel om) {
        ...
        //sbTime.setProgress(5);
        //sbTime.incrementProgressBy(5);
        int max = 60;
        int min = 0;
        int step = 5;
        ...
        rbComplete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rejectReason = rbComplete.getText().toString();
                rbComplete.setChecked(true);
                rbPartial.setChecked(false);
                rbMin.setChecked(false);
                rbHr.setChecked(false);
            }
        });

        rbPartial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rejectReason = rbPartial.getText().toString();
        ...
        rbMin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rejectReason = rbMin.getText().toString();
                rbComplete.setChecked(false);
                rbPartial.setChecked(false);
        ...
        rbHr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rejectReason = rbHr.getText().toString();
                rbComplete.setChecked(false);
                rbPartial.setChecked(false);
                rbMin.setChecked(false);
