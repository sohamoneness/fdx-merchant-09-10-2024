...
public class AddItemRequestModel {
    ...
    public AddItemRequestModel(String restaurant_id, String category_id, String name,
                               String description, String price, String offer_price, String is_veg,
                               String is_cutlery_required, String min_item_for_cutlery,
                               String in_stock, String image, String is_special,
                               String is_add_on, String add_on_item_id) {
